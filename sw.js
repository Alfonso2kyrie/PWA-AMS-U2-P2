...
const CACHE_STATIC_NAME = 'cache_static'
const CACHE_DYNAMIC_NAME = 'cache_dynamic'
const CACHE_INMUTABLE_NAME = 'cache_inmutable'
...
self.addEventListener('install', (event) => {
    ...
    const promesaCache = caches.open(CACHE_STATIC_NAME).then((cache) => {
        return cache.addAll([
            '/PWA-AMS-U2-P2/',
            '/PWA-AMS-U2-P2/index.html',
            '/PWA-AMS-U2-P2/js/app.js',
            '/PWA-AMS-U2-P2/manifest.json'
        ])
    })
